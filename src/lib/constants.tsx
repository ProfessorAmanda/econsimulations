  ...
  oneSample: [
    {
      ...
      nullH: <TeX math="H_0: \mu \leq "/>,
      alterH: <TeX math="H_a: \mu \gt "/>,
      sides: 1
    },
    {
      type: '<',
      hypoText: 'Option 2: These cows produce less than ',
      nullH: <TeX math="H_0: \mu \geq "/>,
      alterH: <TeX math="H_a: \mu \lt "/>,
      sides: 1
    },
    {
      type: '!=',
      hypoText: 'Option 3: These cows produce an amount not equal to ',
      nullH: <TeX math="H_0: \mu = "/>,
      alterH: <TeX math="H_a: \mu \neq "/>,
      sides: 2
    }
  ],
  twoSample: [
    {
      ...
      nullH: <TeX math="H_0: \mu_1 - \mu_2 \geq 0"/>,
      alterH: <TeX math="H_a: \mu_1 - \mu_2 \lt 0"/>,
      sides: 1
    },
    {
      type: '>',
      hypoText: 'Option 2: These cows produce less than they did before',
      nullH: <TeX math="H_0: \mu_1 - \mu_2 \leq 0"/>,
      alterH: <TeX math="H_a: \mu_1 - \mu_2 \gt 0"/>,
      sides: 1
    },
    {
      type: '!=',
      hypoText: 'Option 3: These cows produce a different amount now compared to before.',
      nullH: <TeX math="H_0: \mu_1 - \mu_2 = 0"/>,
      alterH: <TeX math="H_a: \mu_1 - \mu_2 \neq 0"/>,
      sides: 2
    }
  ]
}
...
export const MODULES = [
  ...
  },
  {
    ...
    description: <>The sampling distributions of the OLS estimators <TeX math="\hat{\beta}_0"/> and <TeX math="\hat{\beta}_1"/> are approximately normal.</>
  },
  {
    name: 'The OLS Estimators are Consistent',
    description: <> If the least squares assumptions hold, the OLS estimators, <TeX math="\hat{\beta}_0"/> and <TeX math="\hat{\beta}_1"/>, converge to the population intercept and slope when the sample is large.</>
  },
  {
  ...
  },
  {
    ...
    description: <>OLS regression with multiple regressors (<TeX math="k"/>) estimates the <TeX math="k+1"/> dimensional plane that best fits the data.</>
  },
  {
    name: 'Fixed Effects',
