...
export default function CoefficientInput({ beta, setBeta, delta, setDelta }) {
  return (
    <div>
      <InputGroup>
        <InputGroup.Text><TeX math="\beta_1"/>, the Coefficient on Study Hours:</InputGroup.Text>
        <Form.Control
          type="number"
          step={0.1}
          value={beta}
      ...
      <br/>
      <InputGroup>
        <InputGroup.Text><TeX math="\delta_1"/>, the Coefficient on Sleep Hours:</InputGroup.Text>
        <Form.Control
          type="number"
          step={0.1}
          value={delta}
